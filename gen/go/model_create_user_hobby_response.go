...
type _CreateUserHobbyResponse CreateUserHobbyResponse
...
func (o *CreateUserHobbyResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateUserHobbyResponse := _CreateUserHobbyResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateUserHobbyResponse)

	if err != nil {
		return err
	}

	*o = CreateUserHobbyResponse(varCreateUserHobbyResponse)
